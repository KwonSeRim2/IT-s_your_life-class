...
public class SampleController {
    ...
    //get 과 post 모두허용
    @RequestMapping(value = "/basic", method = {RequestMethod.GET,RequestMethod.POST}) // url:  /ample/basic
    public void basicGet(){
        log.info("basec get.......");
    }
    @GetMapping(value = "/basicOnlyGet")//url: /sample/basicOnlyGet
    public void basicGet2(){
        log.info("basec only get.......");
    }

    @GetMapping("/ex01")
    public String ex01(SampleDTO dto){
        // dto 기본 생성자의 setter 사용
        log.info(""+dto);
        return "ex01";
    }
    @GetMapping("/ex02")
    ...
    public String ex02(SampleDTO dto,@ModelAttribute("page") int page){
        //dto는 자동으로 뷰에 전달이 되지만 개별 파라미티는 전달 시에는 ModelAttribute 사용
        log.info("dto: "+dto);
        log.info("page: "+page);
        return "sample/ex04";
    }
